...
class role_permission extends Model
{
    ...
    protected $casts = [
        ...
        'dcs_can_reports' => 'boolean',
        'dcs_can_review' => 'boolean',
        'dcs_can_stamping' => 'boolean',
        'dcs_can_database' => 'boolean',
        'dcs_can_manage_files' => 'boolean',
        'dcs_can_random_check' => 'boolean',
