<div id="dts-current-id" class="button-section-container">
    <div class="button-container {{ request()->routeIs('dts') ? 'force-active' : '' }}" onclick="proccedto('{{ route('dts') }}')">
...
<div id="dts-receive-id" class="button-section-container">
    <div class="button-container {{ request()->routeIs('dts.receive') ? 'force-active' : '' }}" onclick="proccedto('{{ route('dts.receive') }}')">
        <div class="button-icon">
            <svg xmlns="http://www.w3.org/2000/svg" width="29" height="29" viewBox="0 0 29 29" fill="none">
                <path d="M22.958 17.9713C23.238 17.9714 23.5061 18.083 23.7041 18.2809C23.9022 18.479 24.0137 18.7478 24.0137 19.028V21.7497C24.0137 22.3503 23.7753 22.9265 23.3506 23.3512C22.9259 23.7759 22.3496 24.0143 21.749 24.0143H7.24902C6.64861 24.0142 6.07304 23.7757 5.64844 23.3512C5.22375 22.9265 4.98438 22.3503 4.98438 21.7497V19.028C4.98438 18.7479 5.09598 18.479 5.29395 18.2809C5.49203 18.0828 5.76088 17.9713 6.04102 17.9713C6.32115 17.9713 6.59 18.0828 6.78809 18.2809C6.98606 18.479 7.09766 18.7479 7.09766 19.028V21.7497C7.09766 21.8335 7.16527 21.9018 7.24902 21.902H21.749C21.7894 21.902 21.8279 21.8856 21.8564 21.8571C21.885 21.8286 21.9014 21.79 21.9014 21.7497V19.028C21.9014 18.7479 22.0129 18.479 22.2109 18.2809C22.409 18.0828 22.6779 17.9713 22.958 17.9713ZM14.7432 4.98502C15.0232 4.98502 15.2922 5.09658 15.4902 5.29459C15.6883 5.49267 15.7998 5.76152 15.7998 6.04166V15.8122C15.7998 16.0923 15.6883 16.3611 15.4902 16.5592C15.2922 16.7573 15.0233 16.8688 14.7432 16.8688C14.4631 16.8687 14.1941 16.7573 13.9961 16.5592C13.7981 16.3612 13.6875 16.0922 13.6875 15.8122V6.04166C13.6875 5.76158 13.7981 5.49266 13.9961 5.29459C14.1941 5.09656 14.4631 4.98509 14.7432 4.98502Z" fill="#4F4F4F" stroke="#4F4F4F" stroke-width="0.3"/>
                <path d="M18.7979 12.4076C18.9377 12.4083 19.0764 12.4369 19.2051 12.4915C19.3337 12.5462 19.4502 12.626 19.5479 12.7259C19.6455 12.8259 19.7219 12.9447 19.7734 13.0746C19.825 13.2045 19.8502 13.3439 19.8477 13.4837C19.8451 13.6234 19.815 13.7611 19.7588 13.889C19.7028 14.0165 19.6212 14.1307 19.5205 14.2269L19.5215 14.2279L15.4814 18.1751C15.2841 18.3678 15.0189 18.4759 14.7432 18.4759C14.4674 18.4759 14.2022 18.3678 14.0049 18.1751L9.96484 14.2279H9.96387C9.76392 14.0321 9.64965 13.7645 9.64648 13.4847C9.64335 13.2048 9.75172 12.935 9.94727 12.7347C10.1429 12.5345 10.4105 12.4198 10.6904 12.4164C10.9701 12.413 11.2401 12.5209 11.4404 12.7162V12.7171L14.7432 15.9427L18.0439 12.7181L18.1221 12.6478C18.2027 12.5816 18.2928 12.5275 18.3896 12.4876C18.519 12.4344 18.658 12.4068 18.7979 12.4076Z" fill="#4F4F4F" stroke="#4F4F4F" stroke-width="0.3"/>
            </svg>
        </div>
        <div class="button-label">
