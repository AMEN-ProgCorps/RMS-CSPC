            ...
            <div class="nav">
                <div class="nav-header-container">
                    ...
                    <div id="nav-contexts" class="subsystem-indicator">
                        ...
                        <div class="subsystem-version">Version: {{ \DB::table(\Illuminate\Support\Facades\Schema::hasTable('sys_subsystems') ? 'sys_subsystems' : 'subsystems')->where('subsystem_name', 'Profile Manager')->value('subsystem_version') ?? 'N/A' }}</div>
                    </div>
                </div>
                <hr>
