...
new #[Layout('layouts.dts')] #[Title('Document Tracking System - Create Application Letter')] class extends Component {
    ...
    public function save()
    {
        ...
        $isRequired = DB::table(\Illuminate\Support\Facades\Schema::hasTable('sys_system_settings') ? 'sys_system_settings' : 'system_settings')->where('key', 'dts_email_access_required_application')->value('value') === 'true';
        if ($isRequired) {
            $this->validate([
...
<div class="rms-container">
    ...
    <form class="rms-form" wire:submit.prevent="save">
            ...
            <div class="actions-row" style="display: flex; gap: 12px; align-items: center; margin-top: 24px; clear: both;">
                ...
                @endif
                @php
                    $emailAccessRequired = DB::table(\Illuminate\Support\Facades\Schema::hasTable('sys_system_settings') ? 'sys_system_settings' : 'system_settings')->where('key', 'dts_email_access_required_application')->value('value') === 'true';
                ...
                <div class="dts-success-body">
                    ...
                    <div class="dts-success-summary-box">
                        <div class="dts-success-summary-row">
                            <span class="dts-success-summary-label">Applicant:</span>
