...
new #[Layout('layouts.dts')] #[Title('Document Tracking System - Create Issuance')] class extends Component {
    ...
    public function save()
    {
        ...
        $userOfficeCode = auth()->user()?->details?->office?->office_code ?? 'RFIO';
        ...
        try {
            ...
            $currentOffice = $this->flow_offices[0] ?? $userOfficeCode;
...
<div class="rms-container">
    ...
    <div class="control-wrapper" style="margin-bottom: 20px;">
        ...
        <div style="display: flex; gap: 8px; flex-wrap: wrap; align-items: center;">
            <select wire:model="issuance_type" class="select-input" style="max-width: 200px; height: 32px; padding: 2px 6px;">
