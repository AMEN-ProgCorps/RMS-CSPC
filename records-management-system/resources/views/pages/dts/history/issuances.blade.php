...
new #[Layout('layouts.dts')] #[Title('DTS - Issuances History')] class extends Component {
    ...
    public function mount(): void
    {
        ...
        if ($perms && !$perms->is_sadm && !$perms->can_dts_use_issuance) {
            abort(403, 'Unauthorized access to Issuances history.');
        }
    }
        ...
        <div class="rms-table-responsive">
            <table class="rms-table">
                ...
                <tbody>
                    ...
                    @empty
                        <tr>
                            <td class="rms-no-data" colspan="6">No issuances history records found.</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
        ...
        <div style="display: grid; grid-template-columns: repeat(auto-fill, minmax(320px, 1fr)); gap: 16px; margin-top: 16px;">
            ...
            @empty
                <div style="grid-column: 1 / -1; background: white; padding: 32px; text-align: center; color: #64748b; border-radius: 12px; border: 1px solid #cbd5e1;">
                    No issuances history records found.
                </div>
            @endforelse
        </div>
    @endif
