...
@push('styles')
    @vite(['resources/css/dts/internal.css'])
@endpush

<div class="dts-page min-h-screen">
    <div class="dts-topbar">
        ...
        <div class="dts-search-wrap">
            ...
            />
            <svg class="dts-search-icon" xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 25 25" fill="none">
    ...
    <div class="dts-table-card max-w-full mx-auto">

        <div class="dts-table-scroll">
            <table class="dts-table">
                <thead>
                    <tr class="dts-thead-row">
                        <th class="dts-th dts-th--wide dts-th--pl-20">SUBJECT</th>
                        <th class="dts-th dts-th--wide dts-th--pl-0">UNIT/COLLEGE</th>
                        <th class="dts-th">REQUESTOR</th>
                        <th class="dts-th">CONTROL NO.</th>
                        <th class="dts-th">DOC TYPE</th>
                        <th class="dts-th dts-th--wide">FROM OFFICE</th>
                        <th class="dts-th">RECEIVED</th>
                        <th class="dts-th dts-th--wide">NEXT OFFICE</th>
                        <th class="dts-th">ACTION NEEDED</th>
                        <th class="dts-th">ELAPSED DAY</th>
                        <th class="dts-th">STATUS</th>
                        <th class="dts-th dts-th--center">VIEW TRANSACTION</th>
                    </tr>
                </thead>

                <tbody>
                    <tr class="dts-tbody-row">
                        <td class="dts-td-empty" colspan="12">No records found.</td>
                    </tr>
                </tbody>
            </table>
        </div>
        ...
        <div class="dts-footer">
            <span class="dts-footer-total">Total Records: <strong>0</strong></span>
            <div class="dts-pagination">
                <button class="dts-page-btn">← Previous</button>
                <span class="dts-page-indicator">Page <strong>1</strong> of <strong>1</strong></span>
                <button class="dts-page-btn">Next →</button>
            </div>
        </div>
