...
new #[Layout('layouts.dts')] #[Title('Document Tracking System - Current Transactions')] class extends Component {
        ...
        <div style="display: flex; gap: 8px; align-items: center;">
            <button 
                ...
                style="
                    ...
                    color: {{ $activeTab === 'all' ? 'white' : 'var(--text-gray)' }};
                    display: flex;
                    align-items: center;
                    gap: 6px;
                    margin-left: -30px;
            ...
            <a 
                ...
                style="
                    ...
                    cursor: pointer;
                    transition: all 0.3s ease;
                    background-color: {{ $activeTab === 'external' ? 'var(--primary-blue)' : 'transparent' }};
                    color: {{ $activeTab === 'external' ? 'white' : 'var(--text-gray)' }};
                    display: flex;
                    align-items: center;
                    gap: 6px;
                "
            ...
            <a 
                ...
                style="
                    ...
                    cursor: pointer;
                    transition: all 0.3s ease;
                    background-color: {{ $activeTab === 'application' ? 'var(--primary-blue)' : 'transparent' }};
                    color: {{ $activeTab === 'application' ? 'white' : 'var(--text-gray)' }};
                    display: flex;
                    align-items: center;
                    gap: 6px;
                "
            ...
            <a 
                ...
                style="
                    ...
                    cursor: pointer;
                    transition: all 0.3s ease;
                    background-color: {{ $activeTab === 'issuances' ? 'var(--primary-blue)' : 'transparent' }};
                    color: {{ $activeTab === 'issuances' ? 'white' : 'var(--text-gray)' }};
                    display: flex;
                    align-items: center;
                    gap: 6px;
                "
