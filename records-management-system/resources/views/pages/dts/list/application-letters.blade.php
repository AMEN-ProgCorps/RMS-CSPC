                        ...
                        <div class="receive-field-row" style="align-items: center;">
                            ...
                            @else
                                @php
                                    ...
                                    $flowName = \App\Services\DocumentStorageService::resolveFlowName($transactionFlow, $flowRow?->referenced_flow, $flowRow?->flow_name, $selectedTransaction->trans_type ?? 'Application Letters');
                                @endphp
