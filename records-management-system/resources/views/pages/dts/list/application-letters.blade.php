...
new #[Layout('layouts.dts')] #[Title('DTS - Application Letters')] class extends Component {
    ...
    public function executeExport()
    {
        ...
        if ($this->exportFormat === 'excel') {
            $rows = \App\Helpers\DtsExportHelper::fetchExportRecords('application_letters', $filters, $this->selectedIds, $this->exportScope);
...
<div class="rms-container">
    ...
    <x-dts.export-modal
        ...
        category="application_letters"
        :available-columns="\App\Helpers\DtsExportHelper::getAvailableColumns('application_letters')"
