...
new #[Layout('layouts.dts')] #[Title('DTS - External Transactions')] class extends Component {
    ...
    {
        $available = \App\Helpers\DtsExportHelper::getAvailableColumns('external');
    ...
    public function executeExport()
    {
        ...
        if ($this->exportFormat === 'excel') {
            $rows = \App\Helpers\DtsExportHelper::fetchExportRecords('external', $filters, $this->selectedIds, $this->exportScope);
...
<div class="rms-container">
    ...
    <x-dts.export-modal
        ...
        category="external"
        :available-columns="\App\Helpers\DtsExportHelper::getAvailableColumns('external')"
