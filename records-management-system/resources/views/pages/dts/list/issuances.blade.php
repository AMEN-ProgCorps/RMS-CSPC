...
new #[Layout('layouts.dts')] #[Title('Document Tracking System - List Issuances')] class extends Component {
    ...
    public function getTransactionsProperty()
    {
        ...
        $query = DB::table('dts_transactions as dt')
            ...
            ->where('dt.trans_type', 'memorandom'); // 'memorandom' trans_type maps to Issuances
            ...
            @forelse ($this->transactions as $index => $t)
                <div class="dts-box-card" style="background: white; border: 1.5px solid #ced4da; border-radius: 12px; padding: 24px; box-shadow: 0 4px 6px -1px rgba(0,0,0,0.05); display: flex; flex-direction: column; justify-content: space-between; position: relative;">
                    ...
                    <div style="font-size: 13px; color: #4b5563; line-height: 1.6; margin-top: 12px; font-family: Roboto, sans-serif;">
                        ...
                        <div style="margin-bottom: 6px;"><strong>Name of Requestor:</strong> {{ $t->requestor_name ?? 'N/A' }}</div>
                        ...
                        <div style="margin-bottom: 14px;"><strong>Type of Document:</strong> {{ $t->document_name ?? $t->classification ?? 'Numbered Memo' }}</div>
