                        ...
                        <div class="receive-field-row" style="align-items: center;">
                            ...
                            @else
                                @php
                                    ...
                                    $flowName = \App\Services\DocumentStorageService::resolveFlowName($transactionFlow, $flowRow?->referenced_flow, $flowRow?->flow_name, $selectedTransaction->trans_type ?? 'Issuances');
                                @endphp
                                ...
                                <div style="display: flex; align-items: center; justify-content: space-between; min-width: max-content; padding: 0 30px; position: relative;">
                                    @forelse ($this->visiblePath as $index => $step)
                                        ...
                                        <div class="dts-timeline-node-wrapper">
                                            ...
                                            <!-- Chevron Connector Arrow -->
                                            @if (!$loop->last)
                                                <div style="display: flex; align-items: center; justify-content: center; padding: 0 10px; color: {{ $isFinished ? '#10b981' : '#cbd5e1' }}; font-size: 16px;">
