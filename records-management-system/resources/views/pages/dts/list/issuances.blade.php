...
new #[Layout('layouts.dts')] #[Title('DTS - Issuances')] class extends Component {
    use WithPagination;
    use WithFileUploads;
    ...
    public function mount(): void
    {
        ...
        if ($perms && !$perms->is_sadm && !$perms->can_dts_use_issuance) {
            abort(403, 'Unauthorized access to Issuance transactions list.');
        }
    }
...
<div class="rms-container">
                ...
                <tbody>
                    @forelse($this->transactions as $index => $t)
                        ...
                        <tr style="background-color: {{ $isChecked ? '#f0f6ff' : '' }};">
                            ...
                            <td>{{ $t->classification ?? 'Numbered Memo' }}</td>
                    ...
                    @empty
                        <tr><td colspan="12" class="rms-no-data">No transactions found.</td></tr>
                    @endforelse
                </tbody>
            </table>
        </div>
            ...
            @forelse ($this->transactions as $index => $t)
                ...
                <div class="dts-box-card {{ $isChecked ? 'selected' : '' }}">
                    ...
                    <div class="dts-box-card-content">
                        ...
                        <div class="dts-box-docname">Type: {{ $t->classification ?? 'Numbered Memo' }}</div>
    ...
    <!-- View QR Code Modal -->
    <div id="dts-qr-view-modal" class="modal-backdrop" wire:ignore wire:key="dts-qr-view-modal-issuances" style="display: none; z-index: 1000000; align-items: center; justify-content: center;" onclick="closeQrViewModal()">
