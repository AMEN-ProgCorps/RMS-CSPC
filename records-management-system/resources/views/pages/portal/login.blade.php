...
<div class="body-container">
    ...
    <div class="login-container @if(!$allowManualLogin) sso-only @endif">
        ...
        <div class="lo-instruction">
            @if(!$allowManualLogin)
                Single Sign-On enabled. Please sign in with your authorized account.
            @else
                Please Enter your login details to login your account
            @endif
        </div>
